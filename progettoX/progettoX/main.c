...
//  progettoX
//
//  Created by Pietro Arsi on 19/08/2019.
//  Copyright © 2019 Pietro Arsi. All rights reserved.
//
...
int main(){
    ...
    FILE * file=fopen("/Users/pietroarsi/Desktop/POLI/API/progetto API/batch1.2.in", "r");
    ...
    do{
        ...
        if(strcmp(input_text, "addent")==0){
            ...
            fscanf(file, "%s", param1);
            fscanf(file, "%s", param2);
            fscanf(file, "%s", param3);
            //printf("addrel\n");
...
void addent_f(char name[], entity* ht_entities[]){
    ...
    if(temp_cursor==NULL){
        ...
        do{
            ...
            else if(strcmp(temp_cursor->name,newent->name)==0 && positioned!=1){
...
void addrel_f(char name1[], char name2[], char rel[], relation** rel_list, entity* ht_entities[]){
    ...
    // relation * newrel;
    // newrel=(relation*)malloc(sizeof(relation));
    ...
    if(temp_cursor==NULL){
        ...
        *rel_list=newrel;
        ...
        //printf("1- aggiungo relazione %s da %s a %s\n", rel, name1, name2);
        ...
        // printf("leggo l'albero di %s\n", newrel->rel_name);
        // inorder_tree_walk((newrel->tree));
        
        //inserisco la relazione nella lista contenuta nella relazione
        //alphabetical_ent_insert(&newrel, name2);
        ...
        if(*rel_list!=NULL && strcmp((*rel_list)->rel_name, rel)>0 && (*rel_list)->next==NULL){
            ...
            //printf("2- aggiungo relazione %s da %s a %s\n", rel, name1, name2);
            ...
            //printf("leggo l'albero di %s\n", (*rel_list)->rel_name);
            //inorder_tree_walk((*rel_list)->tree);
        ...
        do{
            if(strcmp(temp_cursor->rel_name,rel)<0){
                if(temp_cursor->next!=NULL && strcmp(temp_cursor->next->rel_name,rel)>0){
                    ...
                    //printf("3- aggiungo relazione %s da %s a %s\n", rel, name1, name2);
                    ...
                    //printf("4- aggiungo relazione %s da %s a %s\n", rel, name1, name2);
            ...
            else if(strcmp((*rel_list)->rel_name,rel)>0){
                relation * newrel;
                newrel=(relation*)malloc(sizeof(relation));
                strcpy(newrel->rel_name,rel);
                newrel->tree=NULL;
                
                newrel->next=temp_cursor;
                *rel_list=newrel;
                newrel->next_ent=NULL;
                
                //printf("5- aggiungo relazione %s da %s a %s\n", rel, name1, name2);
                ...
                //printf("6- aggiungo relazione %s da %s a %s\n", rel, name1, name2);
                ...
                //printf("leggo l'albero di %s\n", temp_cursor->rel_name);
                //inorder_tree_walk(temp_cursor->tree);
                
                //inserisco la relazione nella lista contenuta nella relazione
                //alphabetical_ent_insert(&temp_cursor, name2);
                ...
                //printf("7- aggiungo relazione %s da %s a %s\n", rel, name1, name2);
    ...
    // //printo la lista di relazioni
    // relation* curs=*rel_list;
    // printf("inizio\n");
    // while (curs!=NULL){
    //     printf("%s\n", curs->rel_name);
    //     curs=curs->next;
    ...
    // printf("ho finito la addrel, printo la lista generata\n");
    // ent_list* curs=(*rel_list)->next_ent;
    // while (curs!=NULL){
    //     printf("relazione: %s, to: %s, count: %d\n", (*rel_list)->rel_name, curs->entid, curs->ingresso);
    //     curs=curs->next;
    // }
    // printf("fine\n");
}
